...
let Textarea = forwardRef<HTMLTextAreaElement, TextareaProps>(
  ({ varient, className, ...props }, ref) => {
    let baseClasses =
      "h-20 w-full resize-none border-0 py-2 placeholder:font-light placeholder:opacity-50 relative text-sm border-0 px-3 text-text outline-none rounded-lg transition-border focus-within:fill-text duration-200";
